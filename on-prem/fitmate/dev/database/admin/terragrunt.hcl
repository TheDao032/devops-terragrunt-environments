  ...
  services = {
    admin = {
      ...
      grants = [
        ...
        { role = "admin_ro_${local.environment}", schema = "public", object_type = "schema", privileges = ["USAGE"] },
        ...
        { role = "admin_ro_${local.environment}", schema = "public", object_type = "table", privileges = ["SELECT"] },
        # FUTURE tables the app role creates (later migrations) — default privilege.
        { role = "admin_ro_${local.environment}", schema = "public", object_type = "table", privileges = ["SELECT"], on_future = true, owner = "admin_app_${local.environment}" },
      ]
    }
  }
}
