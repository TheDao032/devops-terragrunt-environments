...
#
# terraform {
#   source = "../../../../../devops-terraform-modules//on-prem/renesas/vault"
#   # source = "git::git@github.com:TheDao032/devops-terraform-modules.git//on-prem/renesas/vault?ref=${local.environment}"
# }
#
# # dependency "consul" {
# #   config_path = "../consul"
