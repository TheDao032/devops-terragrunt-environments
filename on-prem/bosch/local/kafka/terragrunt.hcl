...
terraform {
  source = "../../../../../devops-terraform-modules//on-prem/bosch/kafka"
  # source = "git::git@github.com:TheDao032/devops-terraform-modules.git//on-prem/bosch/kafka?ref=${local.environment}"
}
