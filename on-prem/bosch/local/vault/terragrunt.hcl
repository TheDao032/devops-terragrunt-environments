...
#
# terraform {
#   source = "../../../../../devops-terraform-modules//on-prem/bosch/vault"
#   # source = "git::git@github.com:TheDao032/devops-terraform-modules.git//on-prem/bosch/vault?ref=${local.environment}"
# }
#
# # dependency "consul" {
# #   config_path = "../consul"
